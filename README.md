...
### Versão Mobile
<img src="screenshots/tela-mobile.png" alt="Tela inicial versão mobile" width="300">

### Versão Desktop
<img src="screenshots/tela-desktop.png" alt="Tela inicial versão desktop" width="600">
...
* **Ajuda Imediata:** Acesso rápido aos discadores 190 (Polícia) e 180 (Central de Atendimento à Mulher).
* **Informativo Jurídico:** Explicações simplificadas sobre a *Lei Maria da Penha*, *Lei do Feminicídio* e os tipos de violência (física, psicológica, patrimonial, etc.).
